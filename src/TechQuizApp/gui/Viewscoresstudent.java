 ...
 * @author atulb
 */
public class Viewscoresstudent extends javax.swing.JFrame {

    /** Creates new form Viewscoresstudent */
    public Viewscoresstudent() {
        initComponents();
       username.setText("Hello " + UserProfile.getUsername());
       setLocationRelativeTo(null);
       student.setText(UserProfile.getUsername());
       String sid = UserProfile.getUsername();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" STUDENT SCORE PANNEL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viewscoresstudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Viewscoresstudent().setVisible(true);
            }
        });
    }
